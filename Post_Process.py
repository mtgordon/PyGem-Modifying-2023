...
Output_File_Name = 'Post_Processing_File.csv'
frame = 'last'
...
#        full_odb_file_to_analyze = file_to_analyze
#        raw_path_base_file_name = os.path.splitext(full_odb_file)[0]
#        Post_Processing(full_odb_file_to_analyze, full_INP_file_to_analyze, INI_File, Output_File_Name, first_file, raw_path_base_file_name, frame)
#        first_file = 0
#
